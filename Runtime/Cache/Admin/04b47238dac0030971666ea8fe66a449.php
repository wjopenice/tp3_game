...
<body>
	...
	<div class="cf top_nav_list">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="<?php echo ((isset($model['search_key']) && ($model['search_key'] !== ""))?($model['search_key']):'game_name'); ?>" class="search-input" value="<?php echo I('game_name');?>" placeholder="请输入游戏名称">
				<!-- <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('GameSource/lists','model='.$model['name'],false);?>"><i class="btn-search"></i></a> -->
			</div>
            <div class="input-list">
                <a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('GameSource/lists','model='.$model['name'],false);?>">搜索</a>
            </div>
		</div>
	</div>
