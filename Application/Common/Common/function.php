 ...
 * Date 2017-4-15
 */
function sendMail($subject,$body,$to,$attachment_dir=''){
...
*/
    ...
    //$mail->Username   = "1710450686";  // SMTP服务器用户名
    //$mail->Password   = "ujmogqrlmgsabchi";            // SMTP服务器密码    预授权码，非qq密码
    $mail->Username   = "moguwan@mogu9.com";  // SMTP服务器用户名
    $mail->Password   = "pbdzaqtcnvrwdihf";            // SMTP服务器密码    预授权码，非qq密码
    $mail->SetFrom('moguwan@mogu9.com', '北京玩转平台科技有限公司');//发件人
